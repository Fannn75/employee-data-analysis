...
Creación de nuevas variables (edad, email, estado laboral)
...
Este proyecto forma parte de mi proceso de formación en análisis de datos, con el objetivo de fortalecer habilidades en limpieza, transformación y visualización de datos para la toma de decisiones.
